...
import { Shield, Pencil, AlertCircle, User, Briefcase, Users } from 'lucide-react';
      ...
      <div className="profile-page">
        ...
        <div className="profile-header">
          {profile?.profile_picture ? (
            <img className="profile-avatar-lg profile-avatar-img" src={assetUrl(profile.profile_picture)} alt={user?.name} />
          ) : (
          ...
          <button className="profile-save-btn profile-edit-btn" onClick={() => navigate(`${roleBase}/settings`)}>
          ...
          <div className="profile-grid-2col">
            <div className="profile-card">
              ...
              <div className="profile-field-row">
                ...
                <InfoRow label="Number of Children" value={profile?.child_number} />
              </div>
            </div>

            <div className="profile-card">
              <div className="profile-card-title">
                <Briefcase size={13} style={{ marginRight: 6, verticalAlign: -2 }} />
              ...
              <InfoRow label="Technical Skills" value={profile?.technical_skills} />
              <div className="profile-field-row">
                <InfoRow label="Diplomas" value={profile?.diplomas} />
                <InfoRow label="Certifications" value={profile?.certifications} />
              </div>
              <InfoRow label="Skills" value={profile?.skills} />
            </div>

            <div className="profile-card profile-card-span2">
              <div className="profile-card-title">
